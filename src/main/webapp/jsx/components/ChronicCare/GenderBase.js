          ...
          <form>
            ...
            <div className="row">
              <div className="form-group mb-3 col-md-6">
                <FormGroup>
                  <Label>
                    Has your partner ever hit, kicked, slapped, or otherwise
                    physically hurt you
                  </Label>
                  <Input
                    type="select"
              ...
              <div className="form-group mb-3 col-md-6">
                <FormGroup>
                  <Label>
                    Have you been beaten, sexually coerced, raped or threathened
              ...
              <div className="form-group mb-3 col-md-6">
                <FormGroup>
                  <Label>
                    Does Your partner/family deny you food, shelter, freedom of
                    movement livelihood or finance to access health care
                  </Label>
                  <Input
                    type="select"
