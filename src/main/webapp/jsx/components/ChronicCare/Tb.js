...
import {
    FormGroup, Label, CardBody, Spinner, Input, Form, InputGroup,
} from "reactstrap";
...
const TbScreening = (props) => {
    ...
    const handleInputChange = (e) => {
        ...
        // CAD Score logic when tbScreeningType is set to "Chest X-Ray with CAD and/or Symptom screening"
            ...
            if (!isNaN(numericValue) && numericValue !== '') {
                chestXrayDisplay = numericValue >= 34 ? 'Suggestive of TB' : 'Not suggestive of TB';
            }
            ...
            updateObj = {
                ...updateObj, completedTbTreatment: '', specimentCollectedStatus: '',
            };
            updatedTpt = {
                ...updatedTpt,
                weight: "",
            ...
            updateObj = {
                ...updateObj, dateOfDiagnosticTest: '', diagnosticTestType: '', DateDiagnosticTestResultReceived: ""
            };
        } else if (name === 'diagnosticTestType' || value === '') {
            updateObj = {
                ...updateObj, chestXrayDone: '', tbTestResult: '', chestXrayResultTest: '', tbEvaulationOutcome: '',
            };
            ...
            updateObj = {
                ...updateObj, tbType: '', tbTreatmentStarted: '', dateOfChestXrayResultTestDone: ''
            };
            ...
            updateObj = {
                ...updateObj, completionDate: '', treatmentOutcome: '', treatmentCompletionStatus: '',
            };
        } else if (name === 'clinicallyEvaulated' || value === '') {
            updateObj = {
                ...updateObj, chestXrayDone: ''
            };
        } else if (name === 'chestXrayDone' || value === '') {
            updateObj = {
                ...updateObj, dateOfChestXrayResultTestDone: '', chestXrayResultTest: '',
            };
        }
    ...
    useEffect(() => {
        ...
        if (props.tbObj.tbTreatment === "Yes" && props.tbObj.tbScreeningType === "" && props.tbObj.chestXrayResult === "") {
        ...
        // Skip remaining if already on TB treatment
            ...
            if (props.tbObj.tbTreatment === "No" && props.tbObj.tbScreeningType === "Symptom screen (alone)") {
                const noSymptoms = props.tbObj.coughing === "No" && props.tbObj.fever === "No" && props.tbObj.nightSweats === "No" && props.tbObj.losingWeight === "No";
            ...
            if (props.tbObj.tbTreatment === "No" && props.tbObj.tbScreeningType === "Symptom screen (alone)" && patientAge <= 14) {
                const noSymptoms = props.tbObj.coughing === "No" && props.tbObj.fever === "No" && props.tbObj.nightSweats === "No" && props.tbObj.losingWeight === "No" && props.tbObj.historyWithAdults === "No" && props.tbObj.poorWeightGain === "No";
            ...
            if (props.tbObj.tbTreatment === "No" && props.tbObj.tbScreeningType === "Symptom screen (alone)" && patientAge <= 14) {
                const noSymptoms = props.tbObj.coughing === "Yes" || props.tbObj.fever === "Yes" || props.tbObj.nightSweats === "Yes" || props.tbObj.losingWeight === "Yes" || props.tbObj.historyWithAdults === "Yes" || props.tbObj.poorWeightGain === "Yes"
            ...
            if (props.tbObj.tbTreatment === "No" && props.tbObj.tbScreeningType === "Symptom screen (alone)") {
                const hasSymptom = props.tbObj.coughing === "Yes" || props.tbObj.fever === "Yes" || props.tbObj.nightSweats === "Yes" || props.tbObj.losingWeight === "Yes";
            ...
            const pedHasSymptoms = props.tbObj.coughing === "Yes" || props.tbObj.fever === "Yes" || props.tbObj.nightSweats === "Yes" || props.tbObj.losingWeight === "Yes"
            props.tbObj.historyWithAdults === "Yes" || props.tbObj.poorWeightGain === "Yes";
            ...
            if (updatedTbObj.cadOutcome === "Presumptive TB" && updatedTbObj.outcome === "Presumptive TB") {
                updatedTbObj.status = "Presumptive TB";
            }

            if (updatedTbObj.cadOutcome === "Presumptive TB" && updatedTbObj.outcome === "Not Presumptive") {
                updatedTbObj.status = "Presumptive TB";
            }
            if (updatedTbObj.cadOutcome === "Not Presumptive" && updatedTbObj.outcome === "Presumptive TB") {
                updatedTbObj.status = "Presumptive TB";
            }

            if (updatedTbObj.cadOutcome === "Not Presumptive" && updatedTbObj.outcome === "Not Presumptive") {
                updatedTbObj.status = "No signs or symptoms of TB";
            }
...
// Positive smear/TB-LAMP/LF-LAM test
            else if (props.tbObj?.tbTestResult.trim() === "Positive" && ['TB-LAMP', 'LF-LAM', 'Smear Microscopy'].includes(props.tbObj?.diagnosticTestType.trim())) {
                updatedTbObj.tbEvaulationOutcome = "TB Diagnosed";
            }

// Negative smear/TB-LAMP/LF-LAM test
            else if (props.tbObj?.tbTestResult.trim() === "Negative" && ['TB-LAMP', 'LF-LAM', 'Smear Microscopy'].includes(props.tbObj?.diagnosticTestType.trim())) {
                updatedTbObj.tbEvaulationOutcome = "TB Not Diagnosed";
            }

// Specimen collected, sent, test negative, but CXR and clinical eval suggest TB
            else if (props.tbObj?.specimentCollectedStatus.trim() === "Yes" && props.tbObj?.specimentSent.trim() === 'Yes' && ['TB-LAMP', 'LF-LAM', 'Smear Microscopy'].includes(props.tbObj?.diagnosticTestType.trim()) && props.tbObj?.tbTestResult.trim() === "Negative" && props.tbObj?.chestXrayResultTest === "Suggestive of TB" && props.tbObj.clinicallyEvaulated === "Yes") {
                updatedTbObj.tbEvaulationOutcome = "TB Diagnosed";
            }
// Specimen collected, NOT sent, clinical eval YES, CXR NO, result is suggestive
            else if (props.tbObj?.specimentCollectedStatus.trim() === "Yes" && props.tbObj?.specimentSent.trim() === 'No' && props.tbObj?.clinicallyEvaulated === "Yes" && props.tbObj?.chestXrayDone === "No" && props.tbObj?.resultOfClinicalEvaluation === "Suggestive of TB") {
                updatedTbObj.tbEvaulationOutcome = "TB Diagnosed";
            }

// Specimen collected, NOT sent, clinical eval YES, CXR NO, result NOT suggestive
            else if (props.tbObj?.specimentCollectedStatus.trim() === "Yes" && props.tbObj?.specimentSent.trim() === 'No' && props.tbObj?.clinicallyEvaulated === "Yes" && props.tbObj?.chestXrayDone === "No" && props.tbObj?.resultOfClinicalEvaluation === "Not suggestive of TB") {
                updatedTbObj.tbEvaulationOutcome = "TB Not Diagnosed";
            }

// Specimen collected, NOT sent, clinical eval YES, CXR done and result NOT suggestive
            else if (props.tbObj?.specimentCollectedStatus.trim() === "Yes" && props.tbObj?.specimentSent.trim() === 'No' && props.tbObj?.clinicallyEvaulated === "Yes" && props.tbObj?.chestXrayDone === "Yes" && props.tbObj?.chestXrayResultTest === "Not suggestive of TB") {
                updatedTbObj.tbEvaulationOutcome = "TB Not Diagnosed";
            }

// Specimen collected, NOT sent, CXR suggestive + clinical eval YES
            else if (props.tbObj?.specimentCollectedStatus.trim() === "Yes" && props.tbObj?.specimentSent.trim() === 'No' && props.tbObj?.clinicallyEvaulated === "Yes" && props.tbObj?.chestXrayDone === "Yes" && props.tbObj?.chestXrayResultTest === "Suggestive of TB") {
                updatedTbObj.tbEvaulationOutcome = "TB Diagnosed";
            }

// Invalid/Error/Incomplete test results
            else if (props.tbObj?.tbTestResult === "Error" || props.tbObj?.tbTestResult === "Invalid" || props.tbObj?.tbTestResult === "Incomplete") {
          ...
          <form>
            <div className="row">
              <div className="form-group mb-3 col-md-12">
                <FormGroup>
                  ...
                  <InputGroup>
                    ...
                    {errors.tbTreatment !== "" ? (<span className={classes.error}>{errors.tbTreatment}</span>) : ("")}
                </FormGroup>
              </div>
                ...
                <div className="form-group mb-3 col-md-12">
                  <FormGroup>
                    ...
                    {props.errors.tbTreatmentStartDate !== "" ? (<span className={classes.error}>
                ...
                {props.tbObj.tbTreatment === "No" && (<>
                    ...
                    {/* PREVIOUSLY  ON TPT */}
                    <div className="form-group  mb-3 col-md-6">
                      {props.tbObj.currentlyOnTuberculosis === "Yes" && (<FormGroup>
                          <Label>
                    ...
                    {props.tbObj.tbScreeningType === "Symptom screen (alone)" && (<>
                        ...
                        {props.tbObj.tbScreeningType === "Symptom screen (alone)" && patientAge <= 14 && (<>
                                    <div className="form-group mb-3 col-md-6">
                                      <FormGroup>
                                        <Label>
              ...
              <br/>
                ...
                TB Screening Status:
                <b>
                  {" " + props.tbObj.status === "undefined" ? "" : props.tbObj.status}
                </b>
              </p>
            </div>
          </form>
