...
const Tracking = (props) => {
  ...
  const getTreatmentInfo = () => {
    ...
    axios
      .get(
        `${baseUrl}treatment-transfers/info/${facId}/${patientObj.personUuid}`,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
      )
  ...
  const handleSubmit = (e) => {
    ...
    if (validate()) {
      ...
      if (isPatientTransferredOut) {
        toast.error(
          "A transfer-out form has already been filled for this patient",
          {
          ...
          <form>
            <div className="row">
              ...
              <div className="row">
                ...
                <div className="form-group mb-3 col-md-4">
                  <FormGroup>
                    <Label for="">Date of visit 1111111111</Label>
                    <Input
                      type="date"
