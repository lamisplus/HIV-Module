...
import {
    Card, CardBody, FormGroup, Label, InputGroup,
    InputGroupText,
                        ...
                        <CardBody>
                            <form>
                                <div className="row">
                                    ...
                                    {objValues.isViralLoadAtStartOfArt && objValues.isViralLoadAtStartOfArt !== null && (
                                        ...
                                        <div className=" mb-3 col-md-4">
                                            <FormGroup>
                                                ...
                                                {vitalClinicalSupport.bodyWeight !== "" ? (
                                                    <span
                                                        className={classes.error}>{vitalClinicalSupport.bodyWeight}</span>
                                                ) : ""}
                                                {errors.bodyWeight !== "" ? (
                                        ...
                                        <div className="form-group mb-3 col-md-8">
                                            <FormGroup>
                                                ...
                                                {vitalClinicalSupport.systolic !== "" ? (
                                                    <span
                                                        className={classes.error}>{vitalClinicalSupport.systolic}</span>
                                                ) : ""}
                                                {errors.systolic !== "" ? (
                                                ...
                                                {vitalClinicalSupport.diastolic !== "" ? (
                                                    <span
                                                        className={classes.error}>{vitalClinicalSupport.diastolic}</span>
                                                ) : ""}
                                                {errors.diastolic !== "" ? (
