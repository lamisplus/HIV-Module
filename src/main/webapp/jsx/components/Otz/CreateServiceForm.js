...
const CreateServiceForm = (props) => {
  ...
  const submitNewRecord = (values) => {
    ...
    axios
      ...
      .then((response) => {
        ...
        toast.success("Service OTZ enrollment saved successful.");
  ...
  const handleSubmitAdherence = (values) => {
      ...
      .then((response) => {
        ...
        formik.setValues({
          baselineViralLoadAtEnrollment:
            otzData?.data?.baselineViralLoadAtEnrollment,
          dateDone: otzData?.data?.dateDone,
        });
