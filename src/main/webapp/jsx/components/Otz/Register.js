...
const OtzRegister = (props) => {
  ...
  const handleSubmit = async (e) => {
    ...
    observationObj.nutrition = observationObj.genderBase = genderBase;
          ...
          <div className="col-xl-12 col-lg-12">
            <Form>
              ...
              <div className="card">
                ...
                {showEligibility && <>Form will be here</>}
              </div>
              ...
              <div className="card">
                ...
                {showNutrition && <>Form will be here</>}
              </div>
              {/* End Nutritional Status Assessment */}
