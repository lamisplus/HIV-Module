...
const DsdServiceForm = (props) => {
  ...
  const dsdModelTypeObject = {
    ...
    "CBM2 - Community ART Refill Group: Healthcare Worker â€“ led":
      "DSD_MODEL_COMMUNITY_COMMUNITY_ART_REFILL_GROUP:_HEALTHCARE_WORKER_Ã¢â‚¬â€œ_LED",
    "CBM3 - Community ART Refill Group: PLHIV â€“ led ":
      "DSD_MODEL_COMMUNITY_COMMUNITY_ART_REFILL_GROUP:_PLHIV_â€“_LED_",
  ...
  const submitAssessmentForm = (load) => {
    ...
    if (isUpdateState) {
      axios
        .put(
          `${baseUrl}hiv/art/pharmacy/devolve/${props.activeContent.id}`,
          load,
          {
            headers: { Authorization: `Bearer ${token}` },
          }
