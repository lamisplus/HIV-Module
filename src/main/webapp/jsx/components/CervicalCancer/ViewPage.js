...
//     axios
//       .get(
//         `${baseUrl}application-codesets/v2/CERVICAL_CANCER_SCREENING_METHOD`,
//         { headers: { Authorization: `Bearer ${token}` } }
//       )
//       .then((response) => {
...
//     axios
//       .get(
//         `${baseUrl}application-codesets/v2/NEW_SQUAMOCOLUMNAR_JUNCTION_VISIBLE`,
//         { headers: { Authorization: `Bearer ${token}` } }
//       )
//       .then((response) => {
...
//     axios
//       .get(
//         `${baseUrl}application-codesets/v2/REASON_FOR_CERVICAL_CANCER_REFERRAL`,
//         { headers: { Authorization: `Bearer ${token}` } }
//       )
//       .then((response) => {
...
//   };
  const handleInputChange = (e) => {
    ...
    if (
      e.target.name === "screeningResult" &&
      e.target.value !== "CERVICAL_CANCER_RESULT_POSITIVE"
    ) {
