...
const TbScreening = (props) => {
  ...
  useEffect(() => {
    ...
    if (
      (props.tbObj.priorInh !== "" && props.tbObj.priorInh === true) ||
    ...
    if (
      ...
      props.setTbObj({
        ...props.tbObj,
        ["outcome"]: "Presumptive TB case (TB suspect)",
      });
      props.tbObj.eligibleForTPT = "No";
    } else if (
      ...
      props.setTbObj({
        ...props.tbObj,
        ["outcome"]: "No TB sign (not a suspect)",
      });
      //setcontraindicationDisplay(true)
      //props.tbObj.eligibleForTPT="No"
    }
  ...
  const handleInputChange = (e) => {
    alert("sfsdkjl");
    console.log("yes effect: ", props.tbObj.currentlyOnTuberculosis);
  ...
  //     props.setActiveContent({ ...activeContent, showTbTptMonitoring: true });
  //     console.log("activeCont AAA: ", props.activeContent);
  //   }
  // }, [props.tbObj.tbTreatment]);
  return (
    <>
                  ...
                  {props.patientObj && props.patientObj <= 5 && (
                    <>
                      ...
                      <div className="form-group mb-3 col-md-6">
                        <FormGroup>
                          <Label>
                            History of contacts with adults with TB (Paediatrics
                            clients {"<"} months){" "}
                          </Label>
                          <InputGroup>
                            <Input
