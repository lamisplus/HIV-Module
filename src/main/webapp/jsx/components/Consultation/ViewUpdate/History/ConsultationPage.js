    ...
    if (visitID !== "") {
      axios
        ...
        .then((response) => {
          ...
          setTbObj({ ...objTB });
          const adrListObj =
            e.adverseDrugReactions !== null ? e.adverseDrugReactions : adrList;
          setAdrList([...adrListObj]);
          const inffectionObj =
            e.opportunisticInfections !== null
          ...
          tbObj.tbStatusId =
            objValues.tbStatus !== null && objValues.tbStatus !== ""
              ? objValues.tbStatus
              : "";
        })
        .catch((error) => {});
                      ...
                      <div className=" mb-3 col-md-6">
                        <FormGroup>
                          ...
                          >
                            ...
                            {getOptions("PrEP_LEVEL_OF_ADHERENCE").map(
                              (value) => (
                                <option key={value.id} value={value.id}>
                                  {value.display}
                                </option>
                            ...
                            <div className=" mb-3 col-md-6">
                              <FormGroup>
                                ...
                                <Input
                                  ...
                                  value={
                                    objValues.cervicalCancerScreeningStatus
                                  }
                                  onChange={handleInputChange}
                                  style={{
                                    border: "1px solid #014D88",
                            ...
                            <div className=" mb-3 col-md-6">
                              <FormGroup>
                                ...
                                <Input
                                  ...
                                  value={
                                    objValues.cervicalCancerTreatmentProvided
                                  }
                                  onChange={handleInputChange}
                                  style={{
                                    border: "1px solid #014D88",
                      ...
                      <div className=" mb-3 col-md-6">
                        <FormGroup>
                          ...
                          >
                            ...
                            {getOptions("HEPATITIS_SCREENING_RESULT").map(
                              (value) => (
                                <option key={value.code} value={value.code}>
                                  {value.display}
                                </option>
                        ...
                        <div className=" mb-3 col-md-6">
                          <FormGroup>
                            ...
                            >
                              ...
                              {getOptions("FAMILY_PLANNING_METHOD").map(
                                (value) => (
                                  <option key={value.code} value={value.code}>
                                    {value.display}
                                  </option>
...
function TestOrdersList({
  ...
  const testGroupName = testGroupObj.find(
    (x) => x.id === parseInt(testGroupID)
  );
  const testName =
    testGroupName &&
    testGroupName.labTests.find((x) => x.id === parseInt(testTestID));
  const vLIndication =
...
function ArvDrugOrderObjList({
  ...
  const { getOptions } = useCodesets(CODESET_KEYS);
   const adherenceLevel = getOptions("PrEP_LEVEL_OF_ADHERENCE");
