-- +++++++++++++++++++++++++++++++++++ REMOVE EXISTING 6e NDR CODES +++++++++++++++++++++++++++++++++++
DELETE FROM ndr_code_set WHERE code = '6e';
DELETE FROM ndr_code_set WHERE code_description IN ('TDF+3TC+AVT/r', 'AZT+3TC+LPV/r', 'ABC+3TC+LPV/r', 'AZT+3TC+ATV/r');
